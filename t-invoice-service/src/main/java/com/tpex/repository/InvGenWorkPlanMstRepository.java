...
public interface InvGenWorkPlanMstRepository extends JpaRepository<InvGenWorkPlanMstEntity, InvGenWorkPlanMstIdEntity> {
	...
	List<InvGenWorkPlanMstEntity> findByIssueInvoiceDateBetweenAndEtd1BetweenOrderByIssueInvoiceDateAscEtd1AscIdContDestAscIdLinerAscBrokerAscIdRenbanCodeAsc(
			Date dateFromStringDateFormateforInvoiceDate, Date dateFromStringDateFormateforInvoiceDate2,
			Date dateFromStringDateFormateforInvoiceDate3, Date dateFromStringDateFormateforInvoiceDate4);
	
	List<InvGenWorkPlanMstEntity> findByIssueInvoiceDateBetweenOrderByIssueInvoiceDateAscEtd1AscIdContDestAscIdLinerAscBrokerAscIdRenbanCodeAsc(
			Date dateFromStringDateFormateforInvoiceDate, Date dateFromStringDateFormateforInvoiceDate2);
	

	List<InvGenWorkPlanMstEntity> findByEtd1BetweenOrderByIssueInvoiceDateAscEtd1AscIdContDestAscIdLinerAscBrokerAscIdRenbanCodeAsc(Date dateFromStringDateFormateforInvoiceDate,
			Date dateFromStringDateFormateforInvoiceDate2);

	List<InvGenWorkPlanMstEntity> findByIssueInvoiceDateBetweenAndEtd1BetweenAndIdContDestInOrderByIssueInvoiceDateAscEtd1AscIdContDestAscIdLinerAscBrokerAscIdRenbanCodeAsc(
			Date dateFromStringDateFormateforInvoiceDate, Date dateFromStringDateFormateforInvoiceDate2,
			Date dateFromStringDateFormateforInvoiceDate3, Date dateFromStringDateFormateforInvoiceDate4,
			List<String> dstCode);

	List<InvGenWorkPlanMstEntity> findByIssueInvoiceDateBetweenAndIdContDestInOrderByIssueInvoiceDateAscEtd1AscIdContDestAscIdLinerAscBrokerAscIdRenbanCodeAsc(
			Date dateFromStringDateFormateforInvoiceDate, Date dateFromStringDateFormateforInvoiceDate2,
			List<String> dstCode);

	List<InvGenWorkPlanMstEntity> findByEtd1BetweenAndIdContDestInOrderByIssueInvoiceDateAscEtd1AscIdContDestAscIdLinerAscBrokerAscIdRenbanCodeAsc(Date dateFromStringDateFormateforInvoiceDate,
