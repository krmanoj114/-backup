...
public class InvShippingCtrlMstController {
	...
	public ResponseEntity<OemShippingCtrlMstDto> fetchInvShippingCtrlMst() throws IOException {
	...
	// Fetch Renban codes based on container destination code
	public ResponseEntity<ConsigneeAndNotifyPartyDto> fetchConsigneeAndNotifyPartyByBuyer(
			@RequestParam(required = true) String buyer) {
		return new ResponseEntity<>(invShippingCtrlMstService.fetchConsigneeAndNotifyPartyByBuyer(buyer),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<ApiResponseMessage> saveShippingControlMaster(
			@RequestBody List<OemShippingCtrlMstSaveRequestDto> oemShippingCtrlMstSaveRequestDtoList) {
	...
	public ResponseEntity<ApiResponseMessage> deleteShippingControlMaster(
			@RequestBody List<OemShippingCtrlMstDeleteRequestDto> oemShippingCtrlMstDeleteRequestDtoList) {
		...
		return new ResponseEntity<>(
				new ApiResponseMessage(HttpStatus.OK, ConstantUtils.INFO_CM_3002, errorMessageParams), HttpStatus.OK);
	}
