...
public class MpmiInvoiceCoverPageServiceImpl implements MpmiInvoiceCoverPageService {
	...
	private List<MpmiInvoiceCoverPageResponseDto> getMpmiInvoiceCoverPageData(String invNumber) {
		...
		if (invoiceDetails != null) {
			...
			invoiceCoverPageResponseDto.setMark41(invoiceDetails.get(33, String.class));
			invoiceCoverPageResponseDto.setMark42(invoiceDetails.get(34, String.class));
			invoiceCoverPageResponseDto.setMark43(invoiceDetails.get(35, String.class));
			invoiceCoverPageResponseDto.setMark44(invoiceDetails.get(36, String.class));
			invoiceCoverPageResponseDto.setMark51(invoiceDetails.get(37, String.class));
			invoiceCoverPageResponseDto.setMark52(invoiceDetails.get(38, String.class));
			invoiceCoverPageResponseDto.setMark53(invoiceDetails.get(39, String.class));
			invoiceCoverPageResponseDto.setMark54(invoiceDetails.get(40, String.class));
			invoiceCoverPageResponseDto.setMark61(invoiceDetails.get(41, String.class));
			invoiceCoverPageResponseDto.setMark62(invoiceDetails.get(42, String.class));
			invoiceCoverPageResponseDto.setMark63(invoiceDetails.get(43, String.class));
			invoiceCoverPageResponseDto.setMark64(invoiceDetails.get(44, String.class));
