...
public class Binf301DeleteStagingData implements Tasklet, StepExecutionListener {
	@Autowired 
	...
	private void deleteStagingData() {		
		...
		binf301CustomRepository.deleteStagingData(compCode);
	}
	...
	private boolean isAfterError(StepExecution stepExecution) {
		return "Binf301DeleteStagingDataAfterError".equals(stepExecution.getStepName());
	}
