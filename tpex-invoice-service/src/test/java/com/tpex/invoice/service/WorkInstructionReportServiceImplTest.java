...
class WorkInstructionReportServiceImplTest {
	...
	List<WorkInstrReportDTO> setData() {
		...
		dto1.setIICD_BKG_NO("BKKCG9037500");
		dto1.setIND_HAISEN_NO("TB084");
		dto1.setIND_FINAL_DST("537B");
		dto1.setINM_PCK_MTH("MAY'22");
		dto1.setIND_ETD("01/JUN/22");
		dto1.setIND_ETA("12/JUL/22");
		dto1.setIND_VANNING_DT("11/MAY/22");
		dto1.setIND_SHIPPING_COMP("ONE");
		dto1.setIND_VESSEL_NAME_OCEAN("TBA");
		dto1.setIND_VOYAGE_NO_OCEAN("600");
		dto1.setIICD_VAN_PLNT_CD("Gateway(K)");
		dto1.setINV_COUNT(2);
		dto1.setIICD_INV_NO("KR22102701");
		dto1.setINM_MOD_NO(140);
		dto1.setIND_INV_AMT("353193.79");
		dto1.setINP_AICO_NAME("CSUV");
		dto1.setINP_SERIES("NON");
		dto1.setINP_PCK_MTH("CSUV");
		dto1.setRACK_COUNT("0");
		dto1.setNON_DG_20("0");
		dto1.setNON_DG_40("3");
		dto1.setDG_20("0");
		dto1.setDG_40("3");
		dto1.setIND_BUYER("TSM");
		dto1.setMODEL("COROLLA/CSUV");
		dto1.setRBOXDATA_CNT(null);

		WorkInstrReportDTO dto2 = new WorkInstrReportDTO();
		dto2.setIICD_BKG_NO("BKKCG9037500");
		dto2.setIND_HAISEN_NO("TB084");
		dto2.setIND_FINAL_DST("537B");
		dto2.setINM_PCK_MTH("MAY'22");
		dto2.setIND_ETD("01/JUN/22");
		dto2.setIND_ETA("12/JUL/22");
		dto2.setIND_VANNING_DT("11/MAY/22");
		dto2.setIND_SHIPPING_COMP("ONE");
		dto2.setIND_VESSEL_NAME_OCEAN("TBA");
		dto2.setIND_VOYAGE_NO_OCEAN("600");
		dto2.setIICD_VAN_PLNT_CD("Gateway(K)");
		dto2.setINV_COUNT(2);
		dto2.setIICD_INV_NO("KR22102702");
		dto2.setINM_MOD_NO(1);
		dto2.setIND_INV_AMT("4528.87");
		dto2.setINP_AICO_NAME("COROLLA");
		dto2.setINP_SERIES("NON");
		dto2.setINP_PCK_MTH("CSUV");
		dto2.setRACK_COUNT("0");
		dto2.setNON_DG_20("0");
		dto2.setNON_DG_40("3");
		dto2.setDG_20("0");
		dto2.setDG_40("3");
		dto2.setIND_BUYER("TSM");
		dto2.setMODEL("COROLLA/CSUV");
		dto2.setRBOXDATA_CNT(null);
