...
public class PackingListCustomBrokerServiceImpl {
	...
	public Object generateReport(String invNumber,String reportName,String pidUserId, String reportFormat) throws Exception{
		...
		for(Object[] obj : itemData) {
			...
			if (obj[10] != null && !"null".equals(obj[10])) {
			commonDto.setInsIcoFlag(obj[10].toString());
			}
			if (obj[11] != null && !"null".equals(obj[11])) {
		...
		if ("xlsx".equals(fileFormat)) {
			...
			jasperResponse=jasperReportService.getJasperReportDownloadOfflineV1(response, fileFormat, reportName, parameters, config, 0, sb, fileName);
