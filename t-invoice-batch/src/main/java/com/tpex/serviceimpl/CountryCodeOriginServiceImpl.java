...
@Service
public class CountryCodeOriginServiceImpl implements CountryCodeOriginService{

	@Autowired
	private JobLauncher jobLauncher;

	@Autowired
	@Qualifier("countryCodeOriginUploadBatchJob")
	private Job countryCodeOriginUploadBatchJob;


	@Async
	@Override
	public void countryCodeOriginBatchJob(String batchName, String fileName, OemProcessCtrlEntity oemProcessCtrlEntity, String userId) {
		...
		try {
			jobLauncher.run(countryCodeOriginUploadBatchJob, jobParameters);
