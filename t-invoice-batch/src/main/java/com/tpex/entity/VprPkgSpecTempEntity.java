...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "TB_S_VPR_PKG_SPEC")
public class VprPkgSpecTempEntity {
	
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	@Column(name="PKG_SPEC_ID")
	private Integer pkgSpecId;
	...
	@Column(name = "EFF_FROM", columnDefinition = "DATE")
	private LocalDate nvpsEffFrom;

	@Column(name = "AICO_FLG")
	private String nvpsAicoFlg;

	@Column(name = "EFF_TO", columnDefinition = "DATE")
	private LocalDate nvpsEffTo;
	...
	private LocalDateTime nvpsUpdateDate;
