...
public class Bins006StepExecutionListener implements StepExecutionListener {

	private Logger logger = LoggerFactory.getLogger(Bins006StepExecutionListener.class);
	...
	public ExitStatus afterStep(StepExecution stepExecution) {
		...
		if (stepExecution.getWriteCount() == 0) {
			...
			processLogDtlsEntity.setProcessLogMessage(ConstantUtils.NO_DATA_TO_SEND_SAP);
