...
public class JasperReportServiceImpl implements JasperReportService {
	...
	public Object getJasperReportDownloadOnline(List<?> reportData, String fileFormat, String fileTemplateName, String fileName,
			Map<String, Object> reportParameters, Map<String, Object> reportConfiguration) throws FileNotFoundException, JRException, IllegalAccessException, InvocationTargetException, InvalidInputException {
	...
	public ByteArrayOutputStream getOutPutStream(List<?> reportData, String fileFormat, String fileTemplateName,
			Map<String, Object> reportParameters, Map<String, Object> reportConfiguration) 
					throws FileNotFoundException, JRException, InvalidInputException, IllegalAccessException, InvocationTargetException {
		// load the jrxml file and compile it
